...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6 justify-content-center">
          <h3  style="color:red;">Make {{$user->name}} an Admin ?</h3>
        </div>
        <div class="col-sm-3">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <p class="lead">If you Grant Permission to <span style="color:red;">{{$user->name}} </span> as an Admin He/She will be able to perform the following actions</p>
         <ol type="A">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <a href="/Multiflower-Report-System/manager-make-me-admin/{{$user->id}}" class="btn btn-success " >
               <img src="/assets/img/unauthorized-person.png" alt="" style="height:25px;"> Grant Permission Any Way
            </a>
          </div>
